...
# -*- coding: utf-8 -*-
#
# ts_dateloc documentation build configuration file, created by
...
htmlhelp_basename = 'ts_datelocdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'ts_dateloc.tex',
     u'Date and Location Documentation',
     u'Francisco Delgado and Michael Reuter', 'manual'),
]
...
man_pages = [
    ('index', 'ts_dateloc',
     u'Date and Location Documentation',
     [u'Francisco Delgado and Michael Reuter'], 1)
]
